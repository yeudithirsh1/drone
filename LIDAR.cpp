...
{
    {
        lock_guard<mutex> lock(currentScanMutex);
        return currentScan;
    }
}
...
void LIDAR::updateLidarReadingsFromFile(Drone& drone, mutex& mutexReachedDestination, bool reachedDestination, KalmanFilter& kalmanFilter)
{
